...
class MarchWindow(Window):
    ...
    def __init__(self):
        ...
        a = Sphere(Vec3(150.0, 200.0, -150.0), Vec3(1.0, 0.0, 0.0), 35.0)
        b = Sphere(Vec3(350.0, 300.0, -350.0), Vec3(0.0, 1.0, 0.0), 50.0)
        c = Sphere(Vec3(100.0, 100.0, -125.0), Vec3(0.0, 0.0, 1.0), 100.0)
        camera = CameraData()
